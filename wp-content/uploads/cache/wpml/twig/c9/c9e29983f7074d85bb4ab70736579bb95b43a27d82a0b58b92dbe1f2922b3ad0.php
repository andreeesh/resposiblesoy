...
class __TwigTemplate_74984f6ee3a5f39331ac2606ab75baa1f040bf87adf7ed2a3d572b4c9595cb7e extends Twig_Template
{
    ...
    data-mime-type=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->getAttribute(($context["attachment"] ?? null), "mime_type", array()), "html", null, true);
        echo "\"
    data-title=\"";
        // line 8
            ...
            if ((twig_test_empty(($context["target_language"] ?? null)) || (($context["target_language"] ?? null) == $context["code"]))) {
                ...
                ";
                    ...
                    echo "\"
                          title=\"";
                    // line 36
                    echo twig_escape_filter($this->env, sprintf($this->getAttribute(($context["strings"] ?? null), "edit_translation", array()), $this->getAttribute($this->getAttribute(($context["languages"] ?? null), $context["code"], array(), "array"), "name", array())), "html", null, true);
                    echo "\"
                            ";
                    // line 37
    ...
    {
        return new Twig_Source("", "media-translation-table-row.twig", "C:\\Users\\Andres\\Virtualhost\\respsoy\\wp-content\\plugins\\wpml-media-translation\\templates\\menus\\media-translation-table-row.twig");
    }
}
