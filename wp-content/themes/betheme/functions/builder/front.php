...
if (! function_exists('mfn_print_numbers')) {
	/**
	 * [numbers]
	 */
	function mfn_print_numbers($item)
	{
		echo sc_numbers($item['fields']);
	}
}

if (! function_exists('mfn_print_news')) {
	/**
	 * [news]
	 */
	function mfn_print_news($item)
	{
		echo sc_news($item['fields']);
	}
}
