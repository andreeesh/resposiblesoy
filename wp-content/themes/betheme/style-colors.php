...
/* Buttons */
	...
	button, input[type="submit"], input[type="reset"], input[type="button"] {
		background-color: <?php mfn_opts_show( 'color-theme', '#0095eb' ) ?>;
		color: <?php mfn_opts_show( 'color-button-theme', '#ffffff' ) ?>;
	}
	...
	.button-stroke button:hover, .button-stroke input[type="submit"]:hover, .button-stroke input[type="reset"]:hover, .button-stroke input[type="button"]:hover {
		...
		color: <?php mfn_opts_show( 'color-button-theme', '#ffffff' ) ?> !important;
	}
...
/* ============================================================================================================================ */
	...
	a.action_button{
		background-color: <?php mfn_opts_show( 'background-action-button', '#f7f7f7' ) ?>;
		color: <?php mfn_opts_show( 'color-action-button', '#747474' ) ?>;
	}
	.button-stroke a.action_button{
		border-color: <?php mfn_opts_show( 'background-action-button', '#f7f7f7' ) ?>;
	}
	.button-stroke a.action_button:hover{
		background-color: <?php mfn_opts_show( 'background-action-button', '#f7f7f7' ) ?>!important;
	}
...
/* ============================================================================================================================ */
	...
	.button-stroke #popup_contact > .button{
		border-color: <?php mfn_opts_show( 'background-footer-backtotop' ) ?>;
	}
	.button-stroke #back_to_top:hover,
	.button-stroke #popup_contact > .button:hover{
		background-color: <?php mfn_opts_show( 'background-footer-backtotop' ) ?> !important;
	}
...
::-webkit-input-placeholder {
	color: <?php mfn_opts_show( 'color-form-placeholder', '#929292' ) ?>;
}
::-moz-placeholder {
  color: <?php mfn_opts_show( 'color-form-placeholder', '#929292' ) ?>;
}
...
:focus::-webkit-input-placeholder {
	color: <?php mfn_opts_show( 'color-form-placeholder-focus', '#929292' ) ?>;
}
...
<?php if( mfn_opts_get('responsive') ): ?>
	...
	@media only screen and ( max-width: 767px ){
		#Top_bar{
			background-color: <?php mfn_opts_show( 'background-top-left', '#ffffff' ) ?> !important;
		}

		#Action_bar{
			background-color: <?php mfn_opts_show( 'mobile-background-action-bar', '#ffffff' ) ?> !important;
		}
