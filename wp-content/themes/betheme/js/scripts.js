(function($) {
  ...
  $(document).ready(function() {
    ...
    */
    ...
    {
      $("#menu-item-11").toggleClass("mm-active");
      $(".mm-rtrs").toggleClass("hidden");
    });
    ...
    */
    ...
    var scrolled = 0;
    $("#scroll-up-agenda").on("click", function () {
    ...
    $("#scroll-down-agenda").on("click", function () {
        scrolled = scrolled + 200;
        $("#agenda-container").stop().animate({
            scrollTop: scrolled
        });
     ...
     */
     ...
     $('#cross-encuentra').on('click',function(e) { 
      $('#rs-encuentra').addClass('hidden');
      e.preventDefault();
     });
     ...
     */
     ...
     $('#cross-buscador').on('click',function(e) { 
      $('#rs-buscador').addClass('hidden');
      e.preventDefault();
     });
